...
1) infra readiness
    * [Workstation installation and it's configuration](./infra-readiness.md)
...
installing required packages on the baremetal to creation vm's etc

```
###################
# Step#1: Basic Config, Add-ons etc:
###################
sudo -i
dnf update -y
...
+---------+--------+----------------+---------------+----------------+---------+
| quay |   up   | 192.168.125.11 | centos9stream | romantic-goiko |  kvirt  |
+---------+--------+----------------+---------------+----------------+---------+
```
